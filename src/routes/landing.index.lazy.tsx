...
import { LogOut, LogIn, CreditCard, Car, Home, UserSquare2, TrendingUp, ShieldCheck, Truck, Building, UserPlus } from 'lucide-react';
...
export function LandingPage() {
    ...
    const [modalTitle, setModalTitle] = useState("Abra sua conta na Wallet sbX");
    const [modalDesc, setModalDesc] = useState("Simplifique seus arremates com crédito descomplicado.");
    ...
    const openModal = (context: string) => {
        ...
        let title = "Abra sua conta na Wallet sbX";
        let desc = "Simplifique seus arremates com crédito descomplicado.";

        if (context === 'cartao-ofertas') {
            title = "Ativar Limite de Cartão"; desc = "Estude as condições de parcelas sob medida.";
        } else if (context === 'fin-veiculos') {
            title = "Financiamento de Veículos"; desc = "Estude lances parcelados em até 60x.";
        } else if (context === 'fin-imoveis') {
            title = "Simular Imóveis"; desc = "Consiga as melhores taxas em até 240 meses.";
        } else if (context === 'investidores') {
            title = "Ativos como Garantia"; desc = "Converta patrimônio em capital ágil.";
        } else if (context === 'floor-plan') {
            title = "Floor Plan"; desc = "Giro inteligente de até 90 dias para seu showroom.";
        } else if (context === 'seguros-simula') {
            title = "Contratação de Seguros"; desc = "Proteja os seus ativos de forma integrada.";
        }
    ...
    // Padrão Ghost aplicado rigorosamente
    ...
    return (
        <div className="bg-white text-slate-900 antialiased font-sans overflow-x-hidden">
            <style>{`
            ...
            {/* HEADER ATUAL (MANTIDO CONFORME SEU PEDIDO) */}
            ...
            {/* HERO SECTION - Fundo Branco e Imagem Direita com a logo sbXPAY*/}
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
                        <div className="w-full lg:w-6/12 space-y-5 text-center lg:text-left">
                            {/* Ajuste Gemini Pro: Substituição da tag de texto pela imagem da nova logo */}
                            ...
                            <p className="text-sm md:text-base text-slate-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                                A plataforma líder da América Latina é a única com fintech própria. Negocie em um ecossistema seguro, com a proteção que seu patrimônio exige.
                            </p>
                            ...
                            <div className="border-t border-gray-100 pt-5 space-y-4 text-left max-w-xl mx-auto lg:mx-0">
                                ...
                                <div className="flex items-start space-x-3">
                                    <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-purple-50 flex items-center justify-center text-purple-600 mt-0.5">
            ...
            {/* SEÇÃO CARTÃO - Fundo Branco e Imagem Esquerda */}
                    ...
                    <div className="flex flex-col lg:flex-row-reverse items-center justify-between gap-8 lg:gap-12">
                        <div className="w-full lg:w-6/12 space-y-5">
                            ...
                            <div className="space-y-3">
                                <h2 className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">Use seu cartão de crédito na Superbid.</h2>
                            ...
                            <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-md shadow-purple-500/5 space-y-4">
                                <div className="flex items-center space-x-3 text-purple-600 font-bold text-base">
                                    <i className="fa-solid fa-calendar-check text-xl"></i>
                                    <span>Parcele suas compras em até 18x</span>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    <p className="text-slate-600 text-xs leading-relaxed"><strong className="text-slate-900">Para PF e PJ:</strong> Pessoas físicas e jurídicas podem parcelar as aquisições em até 18 vezes.</p>
                                    <p className="text-slate-600 text-xs leading-relaxed"><strong className="text-slate-900">Segurança 3DS:</strong> Protocolo avançado de autenticação (3D Secure) para transações em cartão.</p>
                                </div>
                            </div>
                            <div className="pt-2">
                                <button className="flex items-center justify-center gap-2 px-6 py-3 bg-white border border-purple-600 text-purple-600 font-medium rounded-xl transition-all hover:bg-purple-50">
                                <CreditCard className="w-5 h-5" strokeWidth={1.5} />
                                <span className="font-jakarta tracking-tight">Ofertas parceladas com cartão</span>
                                </button>
                            </div>
                        </div>
                        <div className="w-full lg:w-5/12 relative flex justify-center mt-8 lg:mt-0">
            ...
            {/* SEÇÃO VEÍCULOS - Fundo Branco e Imagem Direita */}
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
                        <div className="w-full lg:w-6/12 space-y-5 text-center lg:text-left">
                            <div className="inline-flex items-center space-x-2 bg-purple-50 px-3 py-1 rounded-full text-purple-700 text-[10px] font-bold uppercase tracking-wider">
                                ...
                                <span>PROCESSO 100% DIGITAL E NECOCIAÇÃO COM ESPECIALISTAS</span>
                            </div>
                            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">Financie seu novo veículo em até 60x.</h2>
                            <p className="text-sm md:text-base text-slate-600 leading-relaxed max-w-2xl mx-auto lg:mx-0">Compre seu carro ou caminhão com as melhores taxas do mercado. Nós fazemos o trabalho pesado de assessoria e buscamos as melhores soluções nas maiores parceiras financeiras do Brasil.</p>
                            <div className="flex gap-4 w-full max-w-2xl">
                            {/* Botão Carros: Fundo Branco, borda roxa */}
                            <button className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-white border border-purple-600 text-purple-600 font-medium rounded-xl transition-all hover:bg-purple-50">
                                <Car className="w-5 h-5" strokeWidth={1.5} />
                                <span className="font-jakarta tracking-tight">Carros financiados</span>
                            </button>
                            
                            {/* Botão Caminhões: Fundo Branco, borda roxa */}
                            <button className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-white border border-purple-600 text-purple-600 font-medium rounded-xl transition-all hover:bg-purple-50">
                                <Truck className="w-5 h-5" strokeWidth={1.5} />
                                <span className="font-jakarta tracking-tight">Caminhões financiados</span>
                            </button>
                            </div>
                        </div>
            ...
            {/* SEÇÃO IMÓVEIS - Fundo Branco e Imagem Esquerda */}
                    ...
                    <div className="flex flex-col lg:flex-row-reverse items-center justify-between gap-8 lg:gap-12">
                        <div className="w-full lg:w-6/12 space-y-5">
                            <div className="inline-flex items-center space-x-2 bg-purple-50 px-3 py-1 rounded-full text-purple-700 text-[10px] font-bold uppercase tracking-wider">
                                ...
                                <span>INVISTA PAGANDO EM ATÉ 240 MESES</span>
                            </div>
                            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">Financie seu novo imóvel em até 240 meses.</h2>
                            <p className="text-sm md:text-base text-slate-600 leading-relaxed">Realize o sonho do imóvel próprio com prazos e taxas especiais. Uma facilidade robusta construída em parceria com os maiores bancos do país.</p>
                            <div className="pt-2">
                                <button className="flex items-center justify-center gap-2 px-6 py-3 bg-white border border-purple-600 text-purple-600 font-medium rounded-xl transition-all hover:bg-purple-50">
                                <Home className="w-5 h-5" strokeWidth={1.5} />
                                <span className="font-jakarta tracking-tight">Imóveis financiados</span>
                                </button>
                            </div>
                        </div>
                        <div className="w-full lg:w-5/12 flex justify-center mt-8 lg:mt-0 relative">
            ...
            {/* SEÇÃO INVESTIDORES - Fundo Branco e Imagem Direita */}
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
                        <div className="w-full lg:w-6/12 space-y-5 text-center lg:text-left">
                            <div className="inline-flex items-center space-x-2 bg-purple-50 px-3 py-1 rounded-full text-purple-700 text-[10px] font-bold uppercase tracking-wider">
                                ...
                                <span>Crédito para Investimentos</span>
                            </div>
                            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">Rentabilize seus ativos investindo na sbX.</h2>
                            <p className="text-sm md:text-base text-slate-600 leading-relaxed max-w-2xl mx-auto lg:mx-0">Use seu próprio imóvel ou carro como garantia e consiga empréstimos com taxas reduzidas para comprar ativos únicos na sbX. Tenha prazos de até 240x para você aproveitar nossas oportunidades exclusivas.</p>
                            <div className="flex gap-4 w-full max-w-2xl">
                            {/* Crédito usando seu carro */}
                            <button className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-white border border-purple-600 text-purple-600 font-medium rounded-xl transition-all hover:bg-purple-50">
                                <Car className="w-5 h-5" strokeWidth={1.5} />
                                <span className="font-jakarta tracking-tight">Crédito usando seu carro</span>
                            </button>
                            
                            {/* Crédito usando seu imóvel */}
                            <button className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-white border border-purple-600 text-purple-600 font-medium rounded-xl transition-all hover:bg-purple-50">
                                <Home className="w-5 h-5" strokeWidth={1.5} />
                                <span className="font-jakarta tracking-tight">Crédito usando seu imóvel</span>
                            </button>
                            </div>
                        </div>
                        <div className="w-full lg:w-5/12 flex justify-center mt-8 lg:mt-0 relative">
            ...
            {/* SEÇÃO FLOOR PLAN - Fundo Branco e Imagem Esquerda */}
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="flex flex-col lg:flex-row-reverse items-center justify-between gap-8 lg:gap-12">
                        <div className="w-full lg:w-6/12 space-y-5">
                            ...
                            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">Floor Plan para pagamento em até 90 dias.</h2>
                            <p className="text-sm md:text-base text-slate-600 leading-relaxed">Você é lojista? Aproveite uma linha de crédito exclusiva para a compra de veículos na nossa plataforma com pagamento facilitado em até 90 dias.</p>
                            <div className="pt-2">
                                <button className="flex items-center justify-center gap-2 px-6 py-3 bg-white border border-purple-600 text-purple-600 font-medium rounded-xl transition-all hover:bg-purple-50">
                                {/* Ícone representando o fluxo contínuo de capital (rotação simula o ciclo) */}
                                <TrendingUp className="w-5 h-5 rotate-90" strokeWidth={1.5} />
                                <span className="font-jakarta tracking-tight">Conheça as condições</span>
                                </button>
                            </div>
                        </div>
                        <div className="w-full lg:w-5/12 flex justify-center mt-8 lg:mt-0 relative">
            ...
            {/* SEÇÃO SEGUROS - Fundo Branco e Imagem Direita */}
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
                        <div className="w-full lg:w-6/12 space-y-5">
                            ...
                            <div className="space-y-3">
                                <h2 className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">Patrimônio protegido.</h2>
                            ...
                            <div className="flex gap-4 w-full max-w-2xl">
                                {/* Cote um seguro residencial */}
                                <button className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-white border border-purple-600 text-purple-600 font-medium rounded-xl transition-all hover:bg-purple-50">
                                <Building className="w-5 h-5" strokeWidth={1.5} />
                                <span className="font-jakarta tracking-tight">Compare seguros residenciais</span>
                                </button>
                            
                                {/* Cote um seguro de veículo */}
                                <button className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-white border border-purple-600 text-purple-600 font-medium rounded-xl transition-all hover:bg-purple-50">
                                    <Car className="w-5 h-5" strokeWidth={1.5} />
                                    <span className="font-jakarta tracking-tight">Compare seguros de veículos</span>
                                </button>
                            </div>
                        </div>
                        <div className="w-full lg:w-5/12 flex justify-center mt-8 lg:mt-0 relative">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm transition-opacity">
                    <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl relative flex flex-col max-h-[90vh] overflow-hidden">
                        <div className="h-1.5 bg-gradient-to-r from-purple-600 to-purple-500 shrink-0"></div>
                        <button onClick={closeModal} className="absolute top-3 right-3 text-gray-400 hover:text-slate-900 text-lg z-10"><i className="fa-solid fa-xmark"></i></button>

                        <div className="p-6 space-y-5 overflow-y-auto">
                            <div className="space-y-1">
                                <h3 className="text-lg font-bold text-slate-900 leading-tight">{modalTitle}</h3>
                                <p className="text-xs text-slate-600 leading-relaxed">{modalDesc}</p>
                            </div>

                            {!isFormSuccess ? (
                                <form onSubmit={handleFormSubmit} className="space-y-3">
                                    <div>
                                        <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-900 mb-1">Nome Completo</label>
                                        <input type="text" required placeholder="Seu nome" className="w-full border border-gray-200 rounded-lg px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-purple-500" />
                                    </div>
                                    <div>
                                        <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-900 mb-1">E-mail</label>
                                        <input type="email" required placeholder="email@exemplo.com" className="w-full border border-gray-200 rounded-lg px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-purple-500" />
                                    </div>
                                    <div className="grid grid-cols-2 gap-3">
                                        <div>
                                            <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-900 mb-1">Telefone</label>
                                            <input type="tel" required placeholder="(11) 99999-9999" className="w-full border border-gray-200 rounded-lg px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-purple-500" />
                                        </div>
                                        <div>
                                            <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-900 mb-1">CPF/CNPJ</label>
                                            <input type="text" required placeholder="000.000.000-00" className="w-full border border-gray-200 rounded-lg px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-purple-500" />
                                        </div>
                                    </div>
                                    <button type="submit" className="w-full bg-purple-600 hover:bg-purple-700 text-white text-sm font-bold py-2.5 rounded-lg transition-all shadow-md mt-2">
                                        Solicitar Contato
                                    </button>
                                </form>
                            ) : (
                                <div className="text-center space-y-3 py-6">
                                    <div className="inline-flex items-center justify-center w-12 h-12 bg-green-100 rounded-full text-green-600 text-2xl"><i className="fa-solid fa-circle-check"></i></div>
                                    <h4 className="text-lg font-bold text-slate-900">Sucesso!</h4>
                                    <p className="text-xs text-slate-600 max-w-[200px] mx-auto">Sua solicitação foi recebida. Um assessor fará o contato.</p>
                                    <button onClick={closeModal} className="bg-gray-100 hover:bg-gray-200 text-slate-700 text-xs font-bold py-2 px-6 rounded-lg mt-3 w-full">Fechar</button>
                                </div>
                            )}
                        </div>
                    </div>
