 ...
 *
 * ============================================================================
 * 🤖 PADRÃO GEMINI PRO ARQUITETURA: ZERO-TRUST NAVIGATION & OLAP TELEMETRY
 * ============================================================================
  ...
  const renderButton = (
    ...
    return (
      <button
        ...
        className={`${sharedButtonClasses} ${isLocked ? "opacity-50 cursor-not-allowed" : ""} w-full md:w-auto`}
      >
        {isCurrentLoading ? (
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
                  <div className="w-full lg:w-6/12 space-y-5">
                    <div className="flex flex-row items-center gap-4 -ml-2 sm:block sm:ml-0">
                      <div className="w-24 sm:hidden flex-shrink-0 relative flex justify-start">
                        ...
                        <div className="relative w-full p-0 flex items-center justify-center z-0">
                          <img src="/assets/home/conta.webp" alt="Segurança sbX Wallet" fetchPriority="high" decoding="async" className="mix-blend-multiply w-full h-auto object-contain relative" />
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start pt-2">
                      <button
                        ...
                        className={`${sharedButtonClasses} w-full md:w-auto ${loginLoading ? "opacity-50 cursor-not-allowed" : ""} ${loading ? "opacity-60 cursor-not-allowed" : ""}`}
                      >
                        {loginLoading ? (
                          <Loader2 className="w-4 h-4 animate-spin" strokeWidth={1.25} />
                        ) : (
                  ...
                  <div className="hidden sm:flex w-full lg:w-5/12 relative justify-center mt-8 lg:mt-0">
                    <div className="relative w-full max-w-sm p-2 flex items-center justify-center z-0">
                      ...
                      <img src="/assets/home/conta.webp" alt="Segurança sbX Wallet" fetchPriority="high" decoding="async" className="mix-blend-multiply w-[90%] h-auto mx-auto object-contain relative" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className={`flex flex-col ${layoutDirecao} items-center justify-between gap-8 lg:gap-12`}>
                  <div className="w-full lg:w-6/12 space-y-5">
                    <div className="flex flex-row items-center gap-4 -ml-2 sm:block sm:ml-0">
                      <div className="w-24 sm:hidden flex-shrink-0 relative flex justify-start">
                        <div className="absolute inset-0 bg-slate-100 rounded-full filter blur-xs transform scale-90"></div>
                        <div className="relative w-full p-0 flex items-center justify-center z-0">
                          <img src="/assets/home/cartao.webp" alt="Cartão" fetchPriority="high" decoding="async" className="mix-blend-multiply w-full h-auto object-contain relative" />
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                      <div className="bg-slate-50/50 border border-slate-100 rounded-xl p-4 flex flex-col gap-2 transition-colors hover:bg-slate-50">
                        ...
                        <p className="text-slate-600 text-xs leading-relaxed">Condições válidas para pessoas físicas e jurídicas aproveitarem o parcelamento com cartão.</p>
                      </div>
                      <div className="bg-slate-50/50 border border-slate-100 rounded-xl p-4 flex flex-col gap-2 transition-colors hover:bg-slate-50">
                        <div className="flex items-center gap-2 text-slate-900 font-bold text-sm">
                          <Plus className="w-4 h-4 text-purple-500" strokeWidth={3} />
                        ...
                        <p className="text-slate-600 text-xs leading-relaxed">Protocolo avançado de autenticação (3D Secure) ativado para garantir transações protegidas e sem fraudes.</p>
                      </div>
                    </div>
                  ...
                  <div className="hidden sm:flex w-full lg:w-5/12 relative justify-center mt-8 lg:mt-0">
                    <div className="relative w-full max-w-sm p-2 flex items-center justify-center z-0">
                      ...
                      <img src="/assets/home/cartao.webp" alt="Cartão" fetchPriority="high" decoding="async" className="mix-blend-multiply w-[90%] h-auto mx-auto object-contain relative" />
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="w-full lg:w-6/12 space-y-5">
                    <div className="flex flex-row items-center gap-4 -ml-2 sm:block sm:ml-0">
                      <div className="w-24 sm:hidden flex-shrink-0 relative flex justify-start">
                        <div className="absolute inset-0 bg-slate-100 rounded-full filter blur-xs transform scale-90"></div>
                        <div className="relative w-full p-0 flex items-center justify-center z-0">
                          <img src="/assets/home/financiamentoveiculos.webp" alt="Veículos" loading="lazy" decoding="async" className="mix-blend-multiply w-full h-auto object-contain relative" />
                        </div>
                      </div>
                      <div className="space-y-2 flex-1">
                ...
                <div className={`flex flex-col ${layoutDirecao} items-center justify-between gap-8 lg:gap-12`}>
                  <div className="w-full lg:w-6/12 space-y-5">
                    <div className="flex flex-row items-center gap-4 -ml-2 sm:block sm:ml-0">
                      <div className="w-24 sm:hidden flex-shrink-0 relative flex justify-start">
                        <div className="absolute inset-0 bg-slate-100 rounded-full filter blur-xs transform scale-90"></div>
                        <div className="relative w-full p-0 flex items-center justify-center z-0">
                          <img src="/assets/home/financiamentoimoveis.webp" alt="Imóveis" className="mix-blend-multiply w-full h-auto object-contain relative" />
                        </div>
                      </div>
                      <div className="space-y-2 flex-1">
                        <div className="inline-flex items-center space-x-2 bg-purple-50 px-3 py-1 rounded-full text-purple-700 text-[10px] font-bold uppercase tracking-wider">
                  ...
                  <div className="hidden sm:flex w-full lg:w-5/12 relative justify-center mt-8 lg:mt-0">
                    <div className="relative w-full max-w-sm p-2 flex items-center justify-center z-0">
                      ...
                      <img src="/assets/home/financiamentoimoveis.webp" alt="Imóveis" loading="lazy" decoding="async" className="mix-blend-multiply w-[90%] h-auto mx-auto object-contain relative" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className={`flex flex-col ${layoutDirecao} items-center justify-between gap-8 lg:gap-12`}>
                  <div className="w-full lg:w-6/12 space-y-5">
                    <div className="flex flex-row items-center gap-4 -ml-2 sm:block sm:ml-0">
                      <div className="w-24 sm:hidden flex-shrink-0 relative flex justify-start">
                        <div className="absolute inset-0 bg-slate-100 rounded-full filter blur-xs transform scale-90"></div>
                        <div className="relative w-full p-0 flex items-center justify-center z-0">
                          <img src="/assets/home/carhomeequity.webp" alt="Rentabilize Ativos" className="mix-blend-multiply w-full h-auto object-contain relative" />
                        </div>
                      </div>
                      <div className="space-y-2 flex-1">
                        <div className="inline-flex items-center space-x-2 bg-purple-50 px-3 py-1 rounded-full text-purple-700 text-[10px] font-bold uppercase tracking-wider">
                  ...
                  <div className="hidden sm:flex w-full lg:w-5/12 relative justify-center mt-8 lg:mt-0">
                    <div className="relative w-full max-w-sm p-2 flex items-center justify-center z-0">
                      ...
                      <img src="/assets/home/carhomeequity.webp" alt="Rentabilize Ativos" loading="lazy" decoding="async" className="mix-blend-multiply w-[90%] h-auto mx-auto object-contain relative" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className={`flex flex-col ${layoutDirecao} items-center justify-between gap-8 lg:gap-12`}>
                  <div className="w-full lg:w-6/12 space-y-5">
                    <div className="flex flex-row items-center gap-4 -ml-2 sm:block sm:ml-0">
                      <div className="w-24 sm:hidden flex-shrink-0 relative flex justify-start">
                        <div className="absolute inset-0 bg-slate-100 rounded-full filter blur-xs transform scale-90"></div>
                        <div className="relative w-full p-0 flex items-center justify-center z-0">
                          <img src="/assets/home/floorplan.webp" alt="Floor Plan" className="mix-blend-multiply w-full h-auto object-contain relative" />
                        </div>
                      </div>
                      <div className="space-y-2 flex-1">
                        <div className="inline-flex items-center space-x-2 bg-purple-50 px-3 py-1 rounded-full text-purple-700 text-[10px] font-bold uppercase tracking-wider">
                  ...
                  <div className="hidden sm:flex w-full lg:w-5/12 relative justify-center mt-8 lg:mt-0">
                    <div className="relative w-full max-w-sm p-2 flex items-center justify-center z-0">
                      ...
                      <img src="/assets/home/floorplan.webp" alt="Floor Plan" loading="lazy" decoding="async" className="mix-blend-multiply w-[90%] h-auto mx-auto object-contain relative" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className={`flex flex-col ${layoutDirecao} items-center justify-between gap-8 lg:gap-12`}>
                  <div className="w-full lg:w-6/12 space-y-5">
                    <div className="flex flex-row items-center gap-4 -ml-2 sm:block sm:ml-0">
                      <div className="w-24 sm:hidden flex-shrink-0 relative flex justify-start">
                        <div className="absolute inset-0 bg-slate-100 rounded-full filter blur-xs transform scale-90"></div>
                        <div className="relative w-full p-0 flex items-center justify-center z-0">
                          <img src="/assets/home/seguros.webp" alt="Proteção sbX" loading="lazy" decoding="async" className="mix-blend-multiply w-full h-auto object-contain relative" />
                        </div>
                      </div>
                      <div className="space-y-2 flex-1">
                        <div className="inline-flex items-center space-x-2 bg-purple-100/80 px-3 py-1 rounded-full text-purple-700 text-[10px] font-bold uppercase tracking-wider">
                  ...
                  <div className="hidden sm:flex w-full lg:w-5/12 relative justify-center mt-8 lg:mt-0">
                    <div className="relative w-full max-w-sm p-2 flex items-center justify-center z-0">
                      ...
                      <img src="/assets/home/seguros.webp" alt="Proteção sbX" loading="lazy" decoding="async" className="mix-blend-multiply w-[90%] h-auto mx-auto object-contain relative" />
                    </div>
                  </div>
                </div>
              </div>
      ...
      <footer className="w-full pt-10 pb-40 md:py-10 mt-auto bg-black border-t border-gray-800">
        <div className="container mx-auto px-6 flex flex-col items-center gap-4 text-center">
          ...
          <div className="flex flex-col gap-1 max-w-xl text-[11px] text-gray-400">
            ...
            <p className="leading-relaxed">sbXPAY Instituição de Pagamento Ltda. é uma instituição autorizada e regulada pelo Banco Central do Brasil.</p>
          </div>
        </div>
      </footer>
