 ...
 * @path src/routes/financiamentos/simulacao.lazy.tsx
 * 
 * =========================================================================
 * 🤖 PADRÃO GEMINI PRO ARQUITETURA: STATELESS WIZARD & DATA INJECTION
 * =========================================================================
 * Ponto de entrada estrutural para a jornada genérica de Simulação/Parceiros.
 ...
 *    `SimulacaoManifest` (JSON-driven UX) para montar as telas dinamicamente,
...
export const Route = createLazyFileRoute("/financiamentos/simulacao")({
  component: SimulacaoConsultPage,
});

function SimulacaoConsultPage() {
