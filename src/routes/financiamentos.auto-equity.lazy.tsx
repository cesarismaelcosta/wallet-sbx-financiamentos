 ...
 * 
 * [ATUALIZAÇÃO DE CONFORMIDADE COM CARTÃO]:
 * - Remoção do container `absolute bg-white` que quebrava o fluxo de background.
 * - Injeção da wrapper `.dark w-full` no componente `<HowItWorks />` para 
 *   garantir o contraste correto na cauda da página.
 * 
